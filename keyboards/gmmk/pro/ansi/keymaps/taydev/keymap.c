...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_VOLD,   KC_VOLU,   KC_MUTE,   KC_MPLY,   RGB_TOG,   RGB_RMOD,  RGB_MOD,  KC_F12,  KC_SLEP,          KC_MUTE,
    ...
    [1] = LAYOUT(
        ...
        _______, _______, KC_UP, _______, _______, _______, _______, _______, _______, KC_ESC, _______, _______, _______, RESET,            _______,
